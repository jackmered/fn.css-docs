        ...
        <article className="x mx-1-5">
          <section className="md-c9 px1-5 mt3">
            ...
            <RulesTable
              title="Float"
              rules={rules.filter((rule) =>
                [".fl", ".fr", ".fn", ".cf::after"].includes(rule.selector)
              )}
            />
            <RulesTable
              title="List"
            ...
            <RulesTable
              title="Opacity"
              rules={rules.filter((rule) =>
                [".op0", ".op25", ".op50", ".op75", ".op100"].includes(
                  rule.selector
                )
              )}
            />
            <RulesTable
              title="Overflow"
              rules={rules.filter((rule) =>
                [".oh", ".os", ".oxh", ".oxs", ".oh", ".oyh", ".oys"].includes(
                  rule.selector
                )
              )}
            />
            ...
            <RulesTable
              title="Visibility"
              rules={rules.filter((rule) =>
                [".vh", ".vv", ".vc"].includes(rule.selector)
              )}
            />
            <br />
          ...
          <aside className="md-c3 px1-5">
            <nav className="psf w100 full-height bg-light pt3">
              <div className="c3 px1">
                <a href="#colours" className="db tdn p0-5 cl-black">
                  Colours
                </a>
                <a href="#background" className="db tdn p0-5 cl-black">
                  Background
                </a>
                <a href="#border" className="db tdn p0-5 cl-black">
                  Border
                </a>
                <a href="#column" className="db tdn p0-5 cl-black">
                  Column
                </a>
                <a href="#cursor" className="db tdn p0-5 cl-black">
                  Cursor
                </a>
                <a href="#display" className="db tdn p0-5 cl-black">
                  Display
                </a>
                <a href="#flex" className="db tdn p0-5 cl-black">
                  Flex
                </a>
                <a href="#float" className="db tdn p0-5 cl-black">
                  Float
                </a>
                <a href="#list" className="db tdn p0-5 cl-black">
                  List
                </a>
                <a href="#margin" className="db tdn p0-5 cl-black">
                  Margin
                </a>
                <a href="#negative-margin" className="db tdn p0-5 cl-black">
                  Negative margin
                </a>
                <a href="#opacity" className="db tdn p0-5 cl-black">
                  Opacity
                </a>
                <a href="#overflow" className="db tdn p0-5 cl-black">
                  Overflow
                </a>
                <a href="#padding" className="db tdn p0-5 cl-black">
                  Padding
                </a>
                <a href="#positioning" className="db tdn p0-5 cl-black">
                  Positioning
                </a>
                <a href="#sizing" className="db tdn p0-5 cl-black">
                  Sizing
                </a>
                <a href="#typography" className="db tdn p0-5 cl-black">
                  Typography
                </a>
                <a href="#visibility" className="db tdn p0-5 cl-black">
                  Visibility
                </a>
              </div>
            </nav>
